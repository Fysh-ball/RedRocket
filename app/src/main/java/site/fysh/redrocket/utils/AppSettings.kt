...
class AppSettings(private val context: Context) {
    ...
    companion object {
        ...
        val LOCATION_ENRICHMENT_ENABLED = booleanPreferencesKey("location_enrichment_enabled")
    }
    ...
    val locationEnrichmentEnabled: Flow<Boolean> = context.dataStore.data.map { it[LOCATION_ENRICHMENT_ENABLED] ?: false }
    ...
    suspend fun setLocationEnrichmentEnabled(enabled: Boolean) {
        context.dataStore.edit { it[LOCATION_ENRICHMENT_ENABLED] = enabled }
    }
